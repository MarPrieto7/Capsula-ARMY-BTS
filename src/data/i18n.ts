...
export const DICT: Record<Lang, Dict> = {
  ...
  pt: {
    ...
    heroQuote1: "Além das montanhas, mais montanhas —", heroQuote2: "e além delas, você.",
  ...
  ja: {
    ...
    heroQuote1: "山の向こうに、また山 —", heroQuote2: "その先に、あなたがいる。",
  ...
  zh: {
    ...
    heroQuote1: "群山之外,还有更多群山 ——", heroQuote2: "再之外,是你。",
    composeStep: "步骤 1 / 2",
    composeTitle: "今天感觉如何?",
