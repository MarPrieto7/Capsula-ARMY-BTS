    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-8 text-foreground">
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <div>
            <div className="text-[10px] uppercase tracking-[0.3em] text-foreground/50">{t.cardMood}</div>
            <div className="font-serif text-2xl leading-tight">{moodLabel}</div>
          </div>
        </div>
        ...
        <div className="mt-auto pt-6">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              <div className="text-[10px] uppercase tracking-[0.3em] text-foreground/50">{t.cardVibe}</div>
              <div className="font-serif text-base text-foreground/90">{capsule.vibe}</div>
            </div>
            <div className="text-right">
              <div className="text-[10px] uppercase tracking-[0.3em] text-foreground/50">{t.cardSealed}</div>
